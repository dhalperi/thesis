...
\item with multiple antennas, all channels within a band are roughly equivalent RSS. in 5\GHz, can see variability attributable to the actual antenna response.
...
\topheading{Accuracy.} How does selecting best channel based entirely on RSSI compare to optimal? Based entirely on ESNR and predicted rate?
