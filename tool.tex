...
\begin{figure}[h!]
	\centering
	\subfigure[The testbed at Intel Labs Seattle contained of 10 nodes spread over 8,100 square feet.\label{fig:intel_testbed}]{
		\includegraphics[scale=1.054]{figures/intel_floorplan_testbed.pdf}
    }
	\subfigure[The testbed at the UW Paul Allen Center comprises of 24 nodes spread over 20,000 square feet.\label{fig:uw_testbed}]{
		\includegraphics[scale=0.62]{figures/floor3_grayscale_noee_testbed.pdf}
	}
	\caption{\label{fig:testbeds} My two indoor 802.11n testbeds. In both testbeds, the nodes are placed to ensure a large number of links between them, a variety of distances between nodes, and diverse scattering characteristics.}
\end{figure}
