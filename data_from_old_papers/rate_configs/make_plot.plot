...
set key font "Helvetica,8" box bottom right vertical invert samplen 1
set xlabel "Data Rate (Mbps)"
set ytics font "Helvetica,8" ("SIMO" 1.35, "MIMO2/3" 2.125, "SGI" 3, "HT40" 4, "SGI+HT40" 5)
set xtics font "Helvetica,8" 50
set mxtics 2
set pointsize 1.5
set grid xtics ls 9
