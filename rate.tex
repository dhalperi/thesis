...
One strength of my model is that it can accommodate choices other than rates. This lets us add other functionality to ESNR without increasing complexity. \chapref{chap:delivery} demonstrated an example enhancement to trim excess transmit power.
